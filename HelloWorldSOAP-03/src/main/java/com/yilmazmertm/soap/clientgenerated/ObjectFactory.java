 ...
 * generated in the com.yilmazmertm.soap.clientgenerated package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://ws.soap.yilmazmertm.com/", "getHelloWorldAsString");
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://ws.soap.yilmazmertm.com/", "getHelloWorldAsStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.yilmazmertm.soap.clientgenerated
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.soap.yilmazmertm.com/", name = "getHelloWorldAsString")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.soap.yilmazmertm.com/", name = "getHelloWorldAsStringResponse")
