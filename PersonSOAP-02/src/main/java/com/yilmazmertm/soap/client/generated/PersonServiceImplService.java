 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://soap.yilmazmertm.com/", wsdlLocation = "http://localhost:8888/ws/person?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://soap.yilmazmertm.com/", "PersonServiceImplService");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://soap.yilmazmertm.com/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.yilmazmertm.com/", "PersonServiceImplPort"), PersonService.class, features);
    }
