 ...
 * 
 */
@WebServiceClient(name = "CountryServiceImplService", targetNamespace = "http://server.soap.yilmazmertm.com/", wsdlLocation = "http://localhost:8888/ws/country?wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRYSERVICEIMPLSERVICE_QNAME = new QName("http://server.soap.yilmazmertm.com/", "CountryServiceImplService");
    ...
    public CountryService getCountryServiceImplPort() {
        return super.getPort(new QName("http://server.soap.yilmazmertm.com/", "CountryServiceImplPort"), CountryService.class);
    }
    ...
    public CountryService getCountryServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.soap.yilmazmertm.com/", "CountryServiceImplPort"), CountryService.class, features);
    }
